...
func (uu *UserUpdate) AddDepartmentID(u int64) *UserUpdate {
	uu.mutation.AddDepartmentID(u)
	return uu
}
...
// AddDepartmentID adds u to the "department_id" field.
func (uuo *UserUpdateOne) AddDepartmentID(u int64) *UserUpdateOne {
	uuo.mutation.AddDepartmentID(u)
	return uuo
}
